...
# Specify the DIRECTORY path of this file
# FILE_PATH = "?"
FILE_PATH = "" 
...
# "activemq", "camel", "derby", "geronimo", "hcommon",
projects <- c( "hbase", "mahout", "openjpa", "pig", "tuscany")

bootstrap_times <- 1000

# classifiers can be "naive_bayes", "logistic_regression", "random_forest"
classifier <- "naive_bayes"

# method can be "balance", "imbalance", "oneway"
# When choosing "balance", the code also calculate the results for CBS technique
method <- "oneway"
